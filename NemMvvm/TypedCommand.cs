...
namespace NemMvvm {
  ...
  /// <typeparam name="R">For Commands with parameters, the type of parameter used in the CanExecute methods.</typeparam>
  public sealed class Command<T, R> : BaseCommand<T, R> {
    /// <summary>
    ...
    public Command(Action<T> execute, Func<R, bool> canExecute = null) : base(null, null, execute, canExecute) { }
...
#pragma warning restore CS0618
    ...
    public bool CanExecute(R parameter) {
      if(parameter == null) {
        throw new ArgumentNullException(nameof(parameter), "null not allowed in Typed Command");
      }
#pragma warning disable CS0618
