...
namespace NemMvvm {
  ...
  /// </summary>
  /// <typeparam name="T1">For Commands with parameters, the type of parameter used in the Execute methods.</typeparam>
  /// <typeparam name="T2">For Commands with parameters, the type of parameter used in the CanExecute methods.</typeparam>
  public sealed class Command<T1, T2> : BaseCommand<T1, T2> {
    /// <summary>
    ...
    public Command(Action<T1> execute, Func<T2, bool> canExecute = null) : base(null, null, execute, canExecute) { }
